...
from tasks.views import add_task_view, all_tasks_view, complete_task_view, completed_tasks_view, delete_task_view, tasks_view, GenericTaskView, GenericTaskCreateView
